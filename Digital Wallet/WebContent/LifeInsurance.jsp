...
<center><h1>Life Insurance</h1></center>
<%
...
%>
  ...
  <form name="frm" method="post" action="EducationFees2.jsp" class="container">
	...
	<label for="Institude Name" id='form1example2'><b>Customer Name</b></label>
     <input type="text" name="cusnm" class='form-control' placeholder="Customer Name">
	
	<label for="Institude Name" id='form1example2'><b>Policy no</b></label>
     <input type="text" name="policy" class='form-control' placeholder="Policy no">
    ...
    <input type="hidden" name="accnm" value="LIC" >
    
    <label for="Plan" id='form1example2'><b>Amount Rs.*</b></label>
